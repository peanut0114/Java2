...
/*
 	...
 	* Management : 재고 관리 (입고, 출고) + 로그인 권한에 따른 접근 제한
 	* 
 	* ProductInfoManagement / ProductStockManagement : 서브프로그램 (management 상속)
 		Info : 제품에 대한 정보를 등록, 수정, 삭제
 		Stock : 제품 입고, 출고, 재고를 관리하는 프로그램
 	...
 	* HW : takeOut table을 이용한 takeOutGoodsDAO 생성
 	...
 	pDAO : ProductDAO (Products 테이블)
	rDAO : ReceivingGoodsDAO (입고내역 테이블)
	tDAO : TakeOutGoodsDAO (출고내역 테이블)
